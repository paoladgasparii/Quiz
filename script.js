...
let score = 0;
let errors = 0; // Nova variável para contar erros

const questions = [
    // ... (Suas 10 perguntas continuam aqui, sem alteração)
    {
    ...
    },
    {
        ...
        answers: [
            { text: 'São os diferentes tipos de cabos de rede.', correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: 'Para aumentar a velocidade máxima da internet.', correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: 'O endereço físico de uma placa de rede.', correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: 'WAN (Rede de Longa Distância)', correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: 'Cabo Coaxial', correct: false },
...
function selectAnswer(e) {
    ...
    // Lógica para incrementar acertos ou erros
    if (correct) {
        score++;
